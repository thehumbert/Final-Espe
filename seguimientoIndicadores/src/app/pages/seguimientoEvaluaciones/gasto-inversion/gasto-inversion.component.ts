...
import { GastoInversion } from 'src/app/models/gastoInversion';
import { GastoInversionService } from 'src/app/services/gastoInversion.service';
...
export class GastoInversionComponent implements OnInit {
  ...
  //Crear Gasto Inversión:
  gastoInversion: GastoInversion;
  departamentos: Departamento[];

  constructor( private gastoInversionService: GastoInversionService, private fb: FormBuilder ) { }
  buscadorAsignado ='';
  pageActual: number =1;
  ...
  get campos1() {
    return this.gastoInversionForm.get('campos1') as FormArray;
  }

  get campos2() {
    return this.gastoInversionForm.get('campos2') as FormArray;
  }
  ...
  createGastoInversion() {
    ...
    this.gastoInversionService.addOpcion(this.gastoInversionForm.value).subscribe( res => {
      console.log(res)
